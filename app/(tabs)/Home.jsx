...
const Home = ({ navigation }) => {
  ...
  const handleHealthQuizPress = () => {
    router.push('/screens/healthQuiz');
  }
        ...
        <SafeAreaView style={styles.mainSafe}>
          <View style={styles.container}>
            ...
            <View style={styles.containerEnd}>
              ...
              <TouchableOpacity style={styles.bton} onPress={handleSearchPress}>
        ...
        <View style={styles.main}>
          <View style={styles.productMain}>
            ...
            <View style={styles.allItms}>
              <TouchableOpacity style={styles.item} onPress={handleHealthDataPress}>
                <View style={styles.itemInsd}>
                  <Image
                    source={require('../../assets/icons/app-icon07.png')}
              ...
              <TouchableOpacity style={styles.item} onPress={handleShopPress}>
                <View style={styles.itemInsd}>
                  <Image
                    source={require('../../assets/icons/app-icon04.png')}
                    style={styles.itemIcn}
                  />
              ...
              <TouchableOpacity style={styles.item} onPress={handleHealthQuizPress}>
                <View style={styles.itemInsd}>
                  <Image
                    source={require('../../assets/icons/bookIcn.png')}
                    style={styles.itemIcn}
                  />
            ...
            <View style={styles.addictionMain}>
              ...
              <View style={styles.allItms}>
                ...
                <View style={styles.addictionitem}>
                  <TouchableOpacity style={styles.addictioninsd} onPress={handleSearchPress}>
                    <Image
                      source={require('../../assets/icons/dineIcn.png')}
                ...
                <View style={styles.addictionitem}>
                  <TouchableOpacity style={styles.addictioninsd} onPress={handleHealthQuizPress}>
                    <Image
                      source={require('../../assets/icons/pcIcn.png')}
                      style={styles.addictionIcn}
                    />
                  </TouchableOpacity>
            ...
            <View style={styles.addictionMain}>
              ...
              <View style={styles.ailItms}>
                ...
                <View style={styles.ailmentImg}>
                  <Image
                    source={require('../../assets/images/bpmeter.jpg')}
                    style={styles.ailImg}
                  />
                </View>
